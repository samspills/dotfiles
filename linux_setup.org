...
#+begin_src shell
git clone https://github.com/samspills/i3scripts ~/.etc/i3scripts
...
#+RESULTS:
| Collecting   | i3ipc                                                                                                                                   |                   |              |              |                                  |       |                     |          |
| Downloading  | https://files.pythonhosted.org/packages/9c/6b/ee11c0d21c80d80cdb0bb8f1c54360a2ea1fdcddced9c6552649969977d2/i3ipc-2.1.1-py3-none-any.whl |                   |              |              |                                  |       |                     |          |
...
| Requirement  | already                                                                                                                                 | satisfied:        | python-xlib  | in           | /usr/lib/python3.7/site-packages | (from | i3ipc)              | (0.24)   |
| Requirement  | already                                                                                                                                 | satisfied:        | six>=1.10.0  | in           | /usr/lib/python3.7/site-packages | (from | python-xlib->i3ipc) | (1.12.0) |
...
| Successfully | installed                                                                                                                               | enum-compat-0.0.2 | i3ipc-2.1.1  |              |                                  |       |                     |          |
...
#+begin_src shell :tangle "~/.config/i3/config"
    ...
    exec --no-startup-id nitrogen --set-zoom-fill --random $HOME/Pictures/desktop_backgrounds
