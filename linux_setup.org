...
#+begin_src shell :tangle "~/.Xresources"
! -- Fonts -- !
URxvt.font: xft:Fire Code Retina:pixelsize=15:antialias=true:hinting=full,xft:Symbola:pixelsize=19:antialias=true:hinting=full
URxvt.boldFont: xft:Fira Code Retina:style=bold:pixelsize=15:antialias=true:hinting=full,xft:Symbola:pixelsize=19:antialias=true:hinting=full
#+end_src
*** zsh
**** Environment
:PROPERTIES:
