...
values."
  ...
  (setq-default
   ...
   ;; Possible values are: `recents' `bookmarked' `projects'.
...
is function is called at the very end of Spacemacs initialization after
